...
# Telecharge et installe ngrok dans le dossier actuel
...
Write-Host "Telechargement de ngrok..." -ForegroundColor Cyan
...
Write-Host "ngrok installe avec succes dans $destDir" -ForegroundColor Green
