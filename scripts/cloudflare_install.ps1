...
# Télécharge et installe cloudflared dans le dossier actuel

$ProgressPreference = 'SilentlyContinue'
$url = "https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-windows-amd64.exe"
$destFile = "scripts/cloudflared.exe"

Write-Host "☁️ Téléchargement de Cloudflare Tunnel (cloudflared)..." -ForegroundColor Cyan
Invoke-WebRequest -Uri $url -OutFile $destFile

Write-Host "✅ cloudflared installé avec succès dans $destFile" -ForegroundColor Green
