  ...
  const cards = [
    {
      ...
      description: "Chargez vos contacts via CSV ou saisissez-les\nmanuellement en quelques clics.",
    ...
    },
    {
      ...
      description: "Revoyez chaque email avant envoi et\nexportez ou envoyez via Brevo SMTP.",
      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          ...
          <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
            Simplifiez votre prospection email
          </div>
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            Importez vos leads, generez des emails avec l'IA et envoyez
            <br />
