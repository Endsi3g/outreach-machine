        ...
        <div className="w-full max-w-[400px] flex flex-col gap-8">
          ...
          <div className="flex items-center gap-1.5">
            {[
              ...
              <div key={i} className="flex items-center gap-1.5">
                <div className="flex items-center gap-1">
                  <div
                    className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-medium ${
                      step.active
                        ...
                        : "bg-[rgba(55,50,47,0.10)] text-[rgba(55,50,47,0.40)]"
                    }`}
                  >
                    {i + 1}
                  </div>
                  <span
                    className={`text-xs font-medium ${
                      step.active ? "text-[#37322F]" : "text-[rgba(55,50,47,0.35)]"
                    }`}
                  >
                    {step.label}
                  </span>
                ...
                {i < 2 && (
                  <div className="w-8 h-px bg-[rgba(55,50,47,0.12)]" />
                )}
              </div>
            ))}
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="name" className="text-[#37322F] text-sm font-medium leading-5">
                Nom complet
              </label>
              <input
                id="name"
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div
                ...
                className={`mt-0.5 w-4 h-4 min-w-4 rounded border flex items-center justify-center transition-all ${
                  agreed
                    ? "bg-[#37322F] border-[#37322F]"
                    : "bg-white border-[rgba(55,50,47,0.25)] group-hover:border-[rgba(55,50,47,0.45)]"
                }`}
              >
                {agreed && (
              ...
              <span className="text-[rgba(55,50,47,0.60)] text-xs leading-5 select-none">
                J&apos;accepte les{" "}
                <Link href="/terms" className="text-[#37322F] font-medium underline underline-offset-2 hover:opacity-70">
                  conditions d&apos;utilisation
                </Link>{" "}
                et la{" "}
                <Link href="/privacy" className="text-[#37322F] font-medium underline underline-offset-2 hover:opacity-70">
            ...
            <button
              ...
              className="relative w-full h-10 bg-[#37322F] rounded-full overflow-hidden flex items-center justify-center hover:bg-[#2A2520] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {/* Social proof */}
          <div className="flex items-center justify-center gap-3 py-2 px-4 bg-[rgba(55,50,47,0.04)] rounded-xl">
            <div className="flex -space-x-2">
              {[
                ...
                <div
                  key={i}
                  className="w-6 h-6 rounded-full border-2 border-[#FBFAF9] bg-[rgba(55,50,47,0.10)] overflow-hidden"
                >
                  <img src={src} alt="User avatar" className="w-full h-full object-cover" />
                </div>
              ))}
            </div>
            <p className="text-[rgba(55,50,47,0.55)] text-xs leading-4">
              <span className="text-[#37322F] font-semibold">+240 equipes</span> utilisent deja Outreach Machine
            </p>
          </div>
